...
#define MAX_QUEUE_LENGTH 1000000 //*jian_m
...
*/
   ...
   /*if (currlogorg->stat.outstanding >= MAX_QUEUE_LENGTH) {
      ...
      //fflush(stderr);
      fprintf (outputfile, "j_debug error! Stopping simulation because of saturation: simtime %f, totalreqs %d\n", simtime, disksim->totalreqs);//*jian_m
      fprintf (outputfile, "j_debug last request:  dev=%d, blk=%d, cnt=%d, %d (R==1)\n",curr->devno, curr->blkno, curr->bcount, (curr->flags & READ));//*jian_m
      //disksim_simstop();
   }*/
   if (req->flags & READ) {
